...
async def test_setup_unload_and_reload_entry(hass, bypass_get_data):  # pylint: disable=unused-argument
...
async def test_setup_entry_exception(hass, error_on_get_data):  # pylint: disable=unused-argument
