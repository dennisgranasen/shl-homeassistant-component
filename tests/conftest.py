...
@pytest.fixture(autouse=True)
def enable_thesportsdb_custom_integration(enable_custom_integrations):
    """Allow Home Assistant to discover the custom TheSportsDB integration."""
    yield
...
def bypass_get_data_fixture():
    ...
    with patch(
        "custom_components.thesportsdb.SportsDbApiClient.async_get_data",
        return_value={"body": []},
    ), patch(
        "custom_components.thesportsdb.SportsDbApiClient.async_connect",
        return_value={"sports": []},
    ):
        yield
